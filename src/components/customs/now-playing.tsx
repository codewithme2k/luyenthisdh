...
import { MusicWaves } from "@/components/customs/music-waves";
import { useNowPlaying } from "@/shared/hooks/use-now-playing";
...
export function SpotifyNowPlaying({
  ...
  const { songUrl, title, artist, albumImageUrl } = data.song;
